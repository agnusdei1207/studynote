...
IT 관리·시스템 설계 및 전문 DB/데이터 엔지니어를 위한 데이터베이스 전 영역 핵심 및 심화 키워드 800선입니다.
...
51. 로깅 엔진 (Logging 엔진) - 복구(Recovery)를 위한 로그(WAL) 작성
...
120. 데이터 역엔지니어링 (Data Reverse 엔진ering)
...
127. 정보 공학 방법론 (Information 엔진ering) - 데이터 중심 개발 (James Martin)
...
---
<strong>총정리 데이터베이스 키워드 : 총 800개 수록</strong> (+파생/분석 확장 시 1,000여 개 커버)
