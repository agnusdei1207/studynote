...
> 1. **본질**: 양손잡이 조직의 핵심은 기존 코어 비즈니스의 심화(Exploitation)와 신규 혁신 비즈니스의 탐험(Exploration)을 동시 수행라는 점에 있다. 이를 현장 의사결정에 연결하는 전략·거버넌스 구조로 이해하면 된다.
...
1. 현재 문제를 양손잡이 조직의 관점으로 봐야 할 이유가 분명한가?
