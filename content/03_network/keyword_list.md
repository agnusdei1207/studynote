...
시스템 설계 및 전문 엔지니어를 위한 데이터통신/네트워크 전 영역 핵심 및 심화 키워드 1,200선입니다.
...
635. IETF (Internet 엔진ering Task Force) 산하 IoT CoRE 워킹그룹 동향
...
- Asynchronous Transmission & Framing
