...
| 항목 | Jekyll + Pagefind | Zola + Pagefind |
|------|-------------------|-----------------|
| **빌드 시간 (100글)** | ~10초 | ~1초 |
| **빌드 시간 (10,000글)** | ~5분 | ~10초 |
| **빌드 시간 (100,000글)** | 2~4시간 | ~2분 |
| **Actions 콜드 스타트** | Ruby 설치 필요 (~15초) | 바이너리 다운 (~3초) |
| **GitHub Pages 호환** | ✅ 공식 네이티브 | ✅ Actions 방식 |
| **플러그인 생태계** | 풍부 | 기본 내장 위주 |
| **학습 비용** | 낮음 | 낮음 (Liquid와 유사) |
