...
시스템 설계 심화 학습을 위한 빅데이터 전 영역 실무자 수준 핵심 키워드
> ⚡ 빅데이터 학습 문제: 단순 플랫폼 나열이 아닌 **아키텍처 선택 근거 + 법·제도 + 비즈니스 가치 + 미래 전망** 통합 서술 요구
...
7. Tungsten 엔진 — CPU/메모리 최적화, Codegen, Off-heap 메모리
...
23. Photon 엔진 (Databricks) — 네이티브 벡터화 Spark 실행 엔진
...
- Datanode Block Storage Heartbeat
- Rack Awareness Fault Tolerance Topology
- Map Function Key Value Output
...
- Hdfs Viewfs
- Data Serialization Avro Protobuf Thrift
- Hadoop Security Kerberos Ranger Atlas
- Apache Oozie
- Unified Analytics
- RDD (Resilient Distributed Dataset) — 불변 분산 데이터셋
- Lazy Evaluation
- Spark Sql Dataframe
- Spark Sql
- Catalyst Optimizer
...
- Healthcare Bigdata
- Public Bigdata
- Manufacturing Bigdata
- Retail Logistics Bigdata
- Media Bigdata
- Sns Bigdata
- Smart City Bigdata
- Agriculture Bigdata
...
- Management
- Management
- 국방 빅데이터 (정보 분석, 적 행동 예측, 보안 위협 탐지)
- Delta Iceberg Hudi
- Management
- ML , LLM
- LLM
...
- Data Contract
- Apache Iceberg
- 양자 컴퓨팅 + 빅데이터 (최적화 문제, 양자 ML 초기 연구)
- Monte Carlo Bigeye
...
- Open Data Fair
- European Data Strategy & Data Spaces
